...
import logo from '../../assets/cotacao.svg';
 ...
 export default function NavBarCotapp (){

    return(
        <header className="p-3 mb-3 border-bottom">
            <div className="container">
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a className="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none" href="/#">
						<img src={logo} width="40" height="32" className="bi me-2" alt="" aria-label="CotApp" loading="lazy"/>
							CotApp
					</a>
                    ...
                    <a className="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
